...
class HSV:
  ...
  # niche khud se added hai(__str__)wala
  def __str__(self):
...
class Point3:
  ...
  # niche wala(__str__) khud se added hai
  def __str__(self):
    """Return:string with contents"""
    return '('+str(self.x)+','+str(self.y)+','+str(self.z)+')'
  # agr __str__ fucn ko comment kren aur str(object) prompt pe call kren to max reccursion depth reached ho jayega because str repe ko call krega and repr str 
  #ko call krega aur ye process chalta rhega. 
  ...
  # repr dono ka kam kr dega(str and repr ka)
